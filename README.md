...
2. 게임 **대사·자막**이 노란 점선 안에 들어오게 맞춥니다.
3. **자동 인식**을 켜면 약 1.5초마다 화면을 읽습니다.
4. 자막 위치에 따라 `하단 자막 / 중앙 / 상단 / 전체`를 바꿉니다.
...
- 게임 전용 폰트, 이펙트, 작은 글자는 가끔 오인식이 납니다. 자막에 바짝 대고 영역을 `하단 자막`으로 두는 게 잘 됩니다.
